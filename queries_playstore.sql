...
SELECT category, AVG(rating) FROM analytics GROUP BY category, rating ORDER BY rating DESC;
...
--Find the top 10 most-reviewed apps that cost between 10 cents and a dollar.
 ...
 --Find the most out of date app:0
 ...
 SELECT app_name, price FROM analytics ORDER BY price LIMIT 1;
