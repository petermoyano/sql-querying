...
INSERT INTO products (name, price, can_be_returned) VALUES ('closet', 159.99, true);
...
--isplay only the products that have a price in between 22.50 and 99.99.--
SELECT name, price, can_be_returned FROM products WHERE price BETWEEN 22.50 AND 99.99;
